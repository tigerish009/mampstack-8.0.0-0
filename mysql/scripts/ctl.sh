...
MYSQL_PIDFILE=/Applications/mampstack-8.0.0-0/mysql/data/mysqld.pid

MYSQL_START="/Applications/mampstack-8.0.0-0/mysql/bin/mysqld_safe --defaults-file=/Applications/mampstack-8.0.0-0/mysql/my.cnf --mysqld=mysqld.bin --socket=/Applications/mampstack-8.0.0-0/mysql/tmp/mysql.sock  --datadir=/Applications/mampstack-8.0.0-0/mysql/data --log-error=/Applications/mampstack-8.0.0-0/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
