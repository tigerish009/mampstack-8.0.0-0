...
HTTPD_PIDFILE=/Applications/mampstack-8.0.0-0/apache2/logs/httpd.pid


HTTPD="/Applications/mampstack-8.0.0-0/apache2/bin/httpd -f /Applications/mampstack-8.0.0-0/apache2/conf/httpd.conf"
...
. /Applications/mampstack-8.0.0-0/apache2/bin/envvars
